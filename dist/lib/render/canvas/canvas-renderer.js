...
var CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderNodeContent = function (paint) {
        return __awaiter(this, void 0, void 0, function () {
            var container, curves, styles, _i, _a, child, image, e_1, image, e_2, iframeRenderer, canvas, size, _b, fontFamily, fontSize, baseline, bounds, x, textBounds, img, image, url, e_3, _c, fontFamily, fontSize, bounds, baseline;
                ...
                switch (_d.label) {
                    ...
                    case 19:
                        if (paint.listValue && container.styles.listStyleType !== list_style_type_1.LIST_STYLE_TYPE.NONE) {
                            ...
                            baseline = this.fontMetrics.getMetrics(fontFamily, fontSize).baseline;
                            this.renderTextWithLetterSpacing(new text_1.TextBounds(paint.listValue, bounds), styles.letterSpacing, baseline);
                            this.ctx.textBaseline = 'bottom';
                            this.ctx.textAlign = 'left';
                        }
                        _d.label = 20;
